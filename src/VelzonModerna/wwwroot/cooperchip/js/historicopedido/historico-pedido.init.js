...
Website: https://cooperchip.com.br/
Contact: contato.cooperchip@gmail.com
File: historico-pedido.init.js
*/
...
function new_link() {
    ...
    var delLink = '<div class="row"><div class="col-lg-12">' +
        '<div class="mb-3">' +
        '<label for="jobTitle1" class="form-label">Nome do Cliente</label>' +
        '<input type="text" class="form-control" id="jobTitle1" placeholder="Nome do Cliente">' +
        '</div></div>' +
        '<div class="col-lg-6">' +
        '<div class="mb-3">' +
        '<label for="companyName" class="form-label">Fornecedor</label>' +
        '<input type="text" class="form-control" id="companyName" placeholder="Fornecedor">' +
        '</div>' +
        '</div>' +
        '<div class="col-lg-6">' +
        '<div class="mb-3">' +
        ...
        '<div class="col-lg-12">' +
        '<div class="mb-3">' +
        '<label for="jobDescription" class="form-label">Descrição deste Histórico</label>' +
        '<textarea class="form-control" id="jobDescription" rows="3" placeholder="Descrição deste Histórico"></textarea>' +
        '</div></div><div class="hstack gap-2 justify-content-end"><a class="btn btn-success" href="javascript:deleteEl(' + count + ')">Excluir</a></div></div>';
